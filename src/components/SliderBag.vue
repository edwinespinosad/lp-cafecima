              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text">
                      <small class="text-body-primary">1.2kg</small>
                    </p>
                    <h5 class="card-title">$000.00 MXN</h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section class="col">
            <div class="card mb-3 bg-black rounded-3" style="max-width: 540px">
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title">Café de regular</h5>
                    <p class="card-text">
                      This is a wider card with supporting text below as a
                      natural lead-in to additional content. This content is a
                      little bit longer.
                    ...
                    <div class="card mb-3 bg-black " style="max-width: 540px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-body-primary">1.2kg</small></p>
                                <h5 class="card-title">$000.00 MXN</h5>
                            </div>
                            </div>
                        </div>
